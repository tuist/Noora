...
swift package --package-path $ROOT_DIR --allow-writing-to-directory $ROOT_DIR/.build/documentation generate-documentation --target macker --disable-indexing --output-path $ROOT_DIR/.build/documentation --transform-for-static-hosting
